...
test("previous state generates max number items of states", function() {
  ...
  expect(result).toMatchObject(currentExpectedState);
});

test("next state generates only first number increament", function() {
  const currentState = "0 0 0 0 0 0 0 0 0".split(" ");
...
test("next state generates zeros when max reached test last number increase", function() {
...
test("next state generates zeros when max reached", function() {
...
test("having same generated state when increase is 0", function() {
  const currentState = "2 1 5 7 29 0 0 14 8".split(" ");
  const currentExpectedState = "2 1 5 7 29 0 0 14 8".split(" ");
...
test("normalize state to 0 when invalid value is passed", function() {
